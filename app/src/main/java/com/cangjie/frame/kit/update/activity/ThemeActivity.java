...
import com.cangjie.frame.kit.update.utils.AppUtils;
import com.cangjie.frame.kit.update.utils.LogUtils;
import com.cangjie.frame.kit.update.utils.ResUtils;
...
public class ThemeActivity extends RootActivity {
    ...
    public AppDownloadListener obtainDownloadListener() {
        return new AppDownloadListener() {
            ...
            public void downloadFail(String msg) {
                ...
                Toast.makeText(ThemeActivity.this, ResUtils.getString(R.string.apk_file_download_fail), Toast.LENGTH_SHORT).show();
            }
    ...
    public static void launch(Context context, DownloadInfo info) {
        launchActivity(context, info, ThemeActivity.class);
    }
