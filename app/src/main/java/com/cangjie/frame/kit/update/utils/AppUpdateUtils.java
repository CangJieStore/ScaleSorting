package com.cangjie.frame.kit.update.utils;
...
import com.cangjie.frame.kit.update.activity.ThemeActivity;
import com.cangjie.frame.kit.update.activity.UpdateBackgroundActivity;
import com.cangjie.frame.kit.update.interfaces.AppDownloadListener;
import com.cangjie.frame.kit.update.interfaces.AppUpdateInfoListener;
import com.cangjie.frame.kit.update.interfaces.MD5CheckListener;
...
import com.cangjie.frame.kit.update.net.HttpCallbackModelListener;
import com.cangjie.frame.kit.update.net.HttpUtils;
import com.cangjie.frame.kit.update.service.UpdateReceiver;
...
public class AppUpdateUtils {
    ...
    public void checkUpdate(DownloadInfo info) {
        ...
        if (!updateConfig.isAutoDownloadBackground()) {
            ThemeActivity.launch(mContext, info);
        } else {
            //直接下载
    ...
    public void download(DownloadInfo info) {
        ...
        downloadUpdateApkFilePath = AppUtils.getAppLocalPath(info.getProdVersionName());
