...
/**
 * @author nvwa@cangjie
 * Create by AS at 2020/7/7 11:32
 */


private const val CangJie_FRAGMENT_TAG = "base.cangjie.permission.fragment.tag"
private const val CangJie_REQUEST_CODE = 0xFF
...
private fun FragmentActivity.getPermissionFragment(): KPermissionFragment =
    supportFragmentManager.findFragmentByTag(CangJie_FRAGMENT_TAG) as? KPermissionFragment
        ?: KPermissionFragment().apply {
            supportFragmentManager.beginTransaction()
                .add(this, CangJie_FRAGMENT_TAG).commitNowAllowingStateLoss()
        }
...
private object PermissionMap {
    private val atomicInteger = AtomicInteger(CangJie_REQUEST_CODE)
