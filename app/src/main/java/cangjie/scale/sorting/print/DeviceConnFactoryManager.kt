...
import cangjie.scale.sorting.print.DeviceConnFactoryManager
...
//                e.printStackTrace();
    ...
    private val mHandler: Handler = object : Handler() {
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                Constant.abnormal_Disconnection -> ToastUtils.show("打印设备异常断开")
                DEFAUIT_COMMAND -> {}
                READ_DATA -> {
